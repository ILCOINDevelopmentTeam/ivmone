...
inline constexpr auto OP_CREATE = create<IVMC_CREATE>;
inline constexpr auto OP_CALL = call<IVMC_CALL>;
inline constexpr auto OP_CALLCODE = call<IVMC_CALLCODE>;
inline constexpr auto OP_RETURN = return_<IVMC_SUCCESS>;
inline constexpr auto OP_DELEGATECALL = call<IVMC_DELEGATECALL>;
inline constexpr auto OP_CREATE2 = create<IVMC_CREATE2>;
inline constexpr auto OP_STATICCALL = call<IVMC_CALL, true>;
